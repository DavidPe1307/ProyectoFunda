		...
		<ul class="menu-horizontal">
			<li><a href="#">
                    ...
                    <ul class="menu-vertical">
					    <li><a href="../frontend/editaccount_user.php">Editar cuenta</a></li>
			...
			<li>
				...
				<ul class="menu-vertical">
					<li><a href="../frontend/user_slots.php">Estado de slots</a></li>
				</ul>
			</li>
			<li><a href="../frontend/registercars_user.html">
